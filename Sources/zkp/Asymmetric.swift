...
extension secp256k1 {
    ...
    public enum Signing {
        ...
        public struct PrivateKey: Equatable {
            ...
            /// Creates a secp256k1 private key for signing from a Distinguished Encoding Rules (DER) encoded
            /// representation.
            ///
            /// - Parameters:
        ...
        public struct PublicKey {
            ...
            public init(xonlyKey: XonlyKey) {
                ...
                baseKey = PublicKeyImplementation(xonlyKey: key)
            }
            ...
            public init(dataRepresentation data: some ContiguousBytes, format: secp256k1.Format) throws {
            ...
            /// Creates a secp256k1 public key for signing from a Distinguished Encoding Rules (DER) encoded
            /// representation.
            ///
            /// - Parameters:
            ///   - derRepresentation: A DER-encoded representation of the key.
            ...
            public init(x963Representation: some ContiguousBytes) throws {
                ...
                case (2 * secp256k1.ByteLength.dimension) + 1:
                    baseKey = try PublicKeyImplementation(dataRepresentation: x963Representation, format: .uncompressed)
        ...
        public struct XonlyKey {
            ...
            public init(dataRepresentation data: some ContiguousBytes, keyParity: Int32) {
